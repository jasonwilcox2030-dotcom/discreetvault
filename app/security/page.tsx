    ...
    <main className="min-h-screen bg-[#05030b] text-white">
      <section className="relative overflow-hidden px-6 py-8 md:py-12">
        ...
        <div className="relative z-10 mx-auto mb-12 flex max-w-6xl items-center justify-between">
          ...
          <a href="/" className="rounded-full border border-orange-500/60 px-5 py-2 text-sm font-bold text-orange-400 transition hover:bg-orange-500 hover:text-white">
            ← Back Home
          </a>
        </div>
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <h1 className="mb-6 max-w-5xl text-4xl font-black leading-tight tracking-tight md:text-6xl">
            ...
            <span className="text-purple-500">protected shipment movement.</span>
          </h1>
          ...
          <p className="mb-14 max-w-3xl text-lg leading-8 text-slate-300">
            ...
            shipment integrity, and secure coordination throughout every stage of transit.
          </p>

          <div className="grid gap-6 md:grid-cols-2">
            {[
              ["Real-Time Monitoring", "Shipments are actively monitored throughout transit with live status visibility and route tracking."],
              ["Protected Handling", "Sensitive shipments are processed using controlled handling procedures and secure routing workflows."],
              ["Verified Delivery", "Delivery confirmation systems help ensure shipments arrive at the correct destination safely."],
              ["Encrypted Systems", "Operational systems and logistics data are managed through protected digital infrastructure."],
            ].map(([title, text]) => (
              <div key={title} className="rounded-3xl border border-purple-500/20 bg-[#0b0714]/90 p-8 shadow-2xl shadow-purple-950/20">
            ...
            <div className="grid items-center gap-8 md:grid-cols-2">
              <div>
                ...
                <p className="text-slate-300">
                  From pickup coordination to delivery confirmation, our logistics workflow is structured for reliability and shipment protection.
                </p>
              </div>

              <div className="flex gap-4 md:justify-end">
                <a href="/track" className="rounded-full bg-orange-500 px-6 py-3 font-bold text-white transition hover:bg-orange-400">
                  Track Shipment
                </a>
                <a href="/contact" className="rounded-full border border-purple-500/60 px-6 py-3 font-bold text-purple-300 transition hover:bg-purple-600 hover:text-white">
                  Contact Support
                </a>
              </div>
            </div>
